...
String fieldname3 = getParameter(request,"fieldname3");
%>
<!DOCTYPE html>
<html>
	<head>
			...
			*/
			...
			function confirm() {
				...
				if (checkedCheckbox.length == 0) {
					...
					parent.$("#"+fieldname).val(level1);
					parent.$("#"+fieldname2).val(level2);
					parent.$("#"+fieldname3).val(Code);
					/*(fieldname=='Title'){
