...
<div class="bg-white modal-box">
    ...
    <div class="modal-body modal-body-btn pd-20 overflow-y-auto">
        ...
        <%
            ...
            String ListSql = "select id,Title,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Category,User,Photo,Principal";
            if(channel.getIsWeight()==1)
                ...
                <table class="table mg-b-0  ui-sortable" id="content-table">
                    ...
                    <%
                        ...
                        while(Rs.next())
                        {
                            ...
                            String Principal =convertNull(Rs.getString("Principal"));
                    ...
                    <tr class="tide_item" No="<%=j%>"   ItemID="<%=id_%>" OrderNumber="<%=OrderNumber%>"  GlobalID="<%=GlobalID%>" id="jTip<%=j%>_id">
                        <td class="valign-middle" align="center" valign="middle">
                            ...
                            <label class="rdiobox mg-b-0 mg-l-10">
                                <input type="radio" name="choose" value="<%=id_%>" title="<%=Title%>" Principal="<%=Principal%>"><span></span>
                            </label>
                            <%}else if(type==2){%>
                            <label class="ckbox mg-b-0 mg-l-10">
                                <input type="checkbox" name="choose" value="<%=id_%>" title="<%=Title%>" Principal="<%=Principal%>"><span></span>
                            </label>
                            <%}%>
                        </td>
                        <td class="hidden-xs-down" valign="middle"><%=Title%></td>
                        <td class="hidden-xs-down" valign="middle"><%=Principal%></td>
        ...
        function next()
        {
            if(type==1){
                ...
                if (checkedCheckbox.length == 0) {
                    ...
                    var Principal = checkedCheckbox.attr("Principal");
                    //console.log(personnelArr);
                    //top.TideDialogClose({suffix: '_1', recall: true, returnValue: {type:1,iconArr:iconArr}});
                    parent.$("#<%=fieldname%>").val(title);
                    parent.$("#<%=fieldname2%>").val(Principal);
