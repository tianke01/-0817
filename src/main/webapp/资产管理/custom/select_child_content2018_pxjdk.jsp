...
String ListSql = "select id,Title,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Category,User,Photo,ShelfName,UpPort,DownPort";
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-medium">配线架名称</th>
							<th class="tx-12-force tx-mont tx-medium">端口号</th>
							<th class="tx-12-force tx-mont tx-medium">上联</th>
							<th class="tx-12-force tx-mont tx-medium">下联</th>
							<%if(IsWeight==1){%>
...
while(Rs.next())
{
	...
	String ShelfName	= convertNull(Rs.getString("ShelfName"));//配线架名称
	String UpPort	= convertNull(Rs.getString("UpPort"));//上联
	String DownPort	= convertNull(Rs.getString("DownPort"));//下联
			...
			<div class="dropdown hidden-sm-up">
				...
				<div class="dropdown-menu pd-10">
					<nav class="nav nav-style-1 flex-column">
						...
						<a href="#" class="nav-link">搜索</a>
						<div class="wd-40 mg-r-5 ht-40 lh-40 mg-l-15">操作:</div>
			             <a href="javascript:recommend();" class="nav-ylink list_delete" >确定引用</a> 
					</nav>
				</div>
				<!-- dropdown-menu -->
			</div>
