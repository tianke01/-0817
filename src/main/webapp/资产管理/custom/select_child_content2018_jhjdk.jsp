...
String ListSql = "select id,Title,Weight,GlobalID,User,FROM_UNIXTIME(ModifiedDate) as ModifiedDate,Status,Category,User,Photo,RelevanceFacility,SwitchName";
				...
				<%if(listType==1){%>
					<thead>
						<tr>
							...
							<th class="tx-12-force tx-mont tx-medium">交换机名称</th>
							<th class="tx-12-force tx-mont tx-medium">端口模块</th>
							<th class="tx-12-force tx-mont tx-medium">关联设备</th>
							<%if(IsWeight==1){%>
...
while(Rs.next())
{
	...
	String RelevanceFacility	= convertNull(Rs.getString("RelevanceFacility"));//关联设备
	String SwitchName	= convertNull(Rs.getString("SwitchName"));//交换机名称
	String StatusDesc = "";
	if(IsDelete!=1){
	if(Status==0)
