...
<body class="collapsed-menu email" onLoad="">
	...
	<div class="br-mainpanel">      
      <iframe src="../custom/select_child_content2018_jhjdk.jsp?ChannelID=<%=ChannelID%>&LinkChannelID=<%=LinkChannelID%>&GlobalID=<%=GlobalID%>&fieldgroup=<%=fieldgroup%>" id="template_frame" style="width: 100%;height: 100%;"  scrolling="auto" frameborder="0" onload="changeFrameHeight(this)"></iframe>  
    </div><!-- br-mainpanel -->
...
//========================================================================
		$.sidebarMenu = function(menu) {
			...
			$(menu).on('click', 'li a', function(e) {
                ...
                changeFrameSrc( window.frames["template_frame"] , "../custom/select_child_content2018_jhjdk.jsp?ChannelID="+ChannelID+"&LinkChannelID="+LinkChannelID+"&GlobalID="+GlobalID+"&fieldgroup="+fieldgroup+"&LinkChannelID2="+LinkChannelID2 );						
			});
		}	
    </script>
</body>
