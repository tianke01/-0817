...
//图片库频道编号
    ...
    if(Submit.equals("Submit"))
    {
        ...
        if(thislevel==3){
            //1.先把旧的第四级删除
            String updatesql2="delete from "+channel_name+" where Level=4 and Parent="+itemid;
...
<div class="bg-white modal-box">
    <form name="form" action="multi_category_edit2018_IP.jsp?channelid=<%=channelid%>&itemid=<%=itemid%>&level=<%=level%>&Submit=Submit" method="post" id="jobform">
