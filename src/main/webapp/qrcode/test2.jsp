...
<head>
    ...
    <script>
        ...
        function getPeriodforEs(types,number,begin,end){
            $.ajax({
                url:"es_qr_code.jsp",
                data:'types='+types+'&number='+number+'&begin='+begin+'&end='+end,
                //data:'qr_codeId='+qr_codeId+'&types='+types+'&number='+number+'&begin='+begin+'&end='+end,
                type:'post',
                dataType:"json",
    ...
    <div class="card bd-0 shadow-base mg-t-20 pd-x-30 pd-t-30 pd-b-30">
        <div class=" bd-0 shadow-base">
            <div class="layui-tab layui-tab-card">
                <div style="height: 30px"><span style="font-size: 20px">二维码名称： 默认二维码名称</span></div>
